...
const FIELD_POSITIONS = {
  ...
  dateNaissance: { x: 210, y: 291.1 },         // Position date de naissance
  villeNaissance: { x: 210, y: 650 },        // Position ville de naissance
  paysNaissance: { x: 210, y: 650 },         // Position pays de naissance
  nationalite: { x: 210, y: 308.7 },           // Position nationalité
  numeroIdentite: { x: 210, y: 324.5 },        // Position numéro d'identité/passeport

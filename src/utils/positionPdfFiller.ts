...
const FIELD_POSITIONS = {
  ...
  dateNaissance: { x: 210, y: 289.9 },         // Position date de naissance
  villeNaissance: { x: 210, y: 650 },        // Position ville de naissance
  paysNaissance: { x: 210, y: 650 },         // Position pays de naissance
  nationalite: { x: 210, y: 309.9 },           // Position nationalité
  numeroIdentite: { x: 210, y: 329.9 },        // Position numéro d'identité/passeport

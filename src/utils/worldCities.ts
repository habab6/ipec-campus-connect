...
export const WORLD_CITIES_MAPPING: Record<string, string> = {
  ...
  // Balkans - Serbie
  "Belgrade": "RS", "Novi Sad": "RS", "Niš": "RS", "Kragujevac": "RS", "Subotica": "RS", "Zrenjanin": "RS", "Pančevo": "RS", "Čačak": "RS", "Novi Pazar": "RS", "Kraljevo": "RS", "Smederevo": "RS", "Leskovac": "RS", "Užice": "RS", "Vranje": "RS", "Valjevo": "RS", "Kruševac": "RS", "Šabac": "RS", "Sombor": "RS", "Jagodina": "RS", "Mladenovac": "RS",
  
  // Croatie
  "Zagreb": "HR", "Split": "HR", "Rijeka": "HR", "Osijek": "HR", "Zadar": "HR", "Slavonski Brod": "HR", "Pula": "HR", "Karlovac": "HR", "Sisak": "HR", "Šibenik": "HR", "Varaždin": "HR", "Velika Gorica": "HR", "Dubrovnik": "HR", "Bjelovar": "HR", "Koprivnica": "HR", "Požega": "HR", "Vukovar": "HR", "Čakovec": "HR", "Vinkovci": "HR", "Nova Gradiška": "HR",
  
  // Bosnie-Herzégovine
  "Sarajevo": "BA", "Banja Luka": "BA", "Tuzla": "BA", "Zenica": "BA", "Mostar": "BA", "Bijeljina": "BA", "Brčko": "BA", "Bihać": "BA", "Prijedor": "BA", "Trebinje": "BA", "Doboj": "BA", "Cazin": "BA", "Bugojno": "BA", "Velika Kladuša": "BA", "Visoko": "BA", "Goražde": "BA", "Konjic": "BA", "Gračanica": "BA", "Gradačac": "BA", "Bosanska Krupa": "BA",
  
  // Slovénie
  "Ljubljana": "SI", "Maribor": "SI", "Celje": "SI", "Kranj": "SI", "Velenje": "SI", "Koper": "SI", "Novo Mesto": "SI", "Ptuj": "SI", "Trbovlje": "SI", "Kamnik": "SI", "Jesenice": "SI", "Nova Gorica": "SI", "Domžale": "SI", "Škofja Loka": "SI", "Murska Sobota": "SI", "Slovenj Gradec": "SI", "Krško": "SI", "Postojna": "SI", "Litija": "SI", "Ajdovščina": "SI",
  
  // Macédoine du Nord
  "Skopje": "MK", "Bitola": "MK", "Kumanovo": "MK", "Prilep": "MK", "Tetovo": "MK", "Veles": "MK", "Štip": "MK", "Ohrid": "MK", "Gostivar": "MK", "Strumica": "MK", "Kavadarci": "MK", "Kočani": "MK", "Kičevo": "MK", "Struga": "MK", "Radoviš": "MK", "Gevgelija": "MK", "Debar": "MK", "Kriva Palanka": "MK", "Sveti Nikole": "MK", "Negotino": "MK",
  
  // Albanie
  "Tirana": "AL", "Durrës": "AL", "Vlorë": "AL", "Elbasan": "AL", "Shkodër": "AL", "Fier": "AL", "Korçë": "AL", "Berat": "AL", "Lushnjë": "AL", "Kavajë": "AL", "Gjirokastër": "AL", "Sarandë": "AL", "Laç": "AL", "Kukës": "AL", "Lezhë": "AL", "Pogradec": "AL", "Krujë": "AL", "Peshkopi": "AL", "Burrel": "AL", "Corovodë": "AL",
  
  // Monténégro
  "Podgorica": "ME", "Nikšić": "ME", "Pljevlja": "ME", "Bijelo Polje": "ME", "Cetinje": "ME", "Bar": "ME", "Herceg Novi": "ME", "Berane": "ME", "Ulcinj": "ME", "Budva": "ME", "Rožaje": "ME", "Kotor": "ME", "Danilovgrad": "ME", "Mojkovac": "ME", "Tivat": "ME", "Andrijevica": "ME", "Kolašin": "ME", "Žabljak": "ME", "Plužine": "ME", "Šavnik": "ME",
  
  // Bulgarie
  "Sofia": "BG", "Plovdiv": "BG", "Varna": "BG", "Burgas": "BG", "Ruse": "BG", "Stara Zagora": "BG", "Pleven": "BG", "Sliven": "BG", "Dobrich": "BG", "Shumen": "BG", "Pernik": "BG", "Haskovo": "BG", "Yambol": "BG", "Pazardzhik": "BG", "Blagoevgrad": "BG", "Veliko Tarnovo": "BG", "Gabrovo": "BG", "Asenovgrad": "BG", "Vidin": "BG", "Vraca": "BG",
  
  // Grèce
  "Athènes": "GR", "Thessalonique": "GR", "Patras": "GR", "Héraklion": "GR", "Larissa": "GR", "Volos": "GR", "Rhodes": "GR", "Ioannina": "GR", "Chania": "GR", "Chalcis": "GR", "Kalamata": "GR", "Kavala": "GR", "Serres": "GR", "Drama": "GR", "Veria": "GR", "Mytilène": "GR", "Lamia": "GR", "Kozani": "GR", "Alexandroupoli": "GR", "Trikala": "GR",
  
  // Turquie européenne
  "Istanbul": "TR", "Edirne": "TR", "Tekirdağ": "TR", "Çorlu": "TR", "Kırklareli": "TR",
